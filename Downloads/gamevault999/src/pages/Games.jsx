...
const categories = [
  { label: 'Slots', color: 'from-pink-500/60 to-amber-400/60', copy: 'High-volatility reels and quick-hit fun.' },
  { label: 'Fish rooms', color: 'from-cyan-400/60 to-blue-500/60', copy: 'Arcade-style hunts with cinematic effects.' },
  { label: 'Jackpots', color: 'from-amber-400/70 to-rose-500/70', copy: 'Progressive pots that spike all night.' },
  { label: 'Tournaments', color: 'from-purple-500/60 to-indigo-500/60', copy: 'Timed events, leaderboards, and bragging rights.' },
]
    ...
    <div className="relative">
      ...
      <section className="section-padding relative overflow-hidden pt-12 md:pt-16 lg:pt-20">
        ...
        <div className="container-custom relative grid lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            <span className="neon-pill">The Vault Library</span>
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              60+ titles tuned for quick-fire thrills, jackpot spikes, and fish-room frenzy.
            </h1>
            <p className="text-lg text-gray-200">
              Built for mobile, loaded with SSL security, and refreshed weekly so your lineup never gets stale.
            </p>
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/players" className="btn-secondary">How to start</Link>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4">
              {[
                { label: 'Hot drop', value: 'Gold Frenzy' },
                { label: 'Fish room', value: 'Neon Shoals' },
                { label: 'Jackpot', value: '$12.4M live' },
              ].map((item) => (
          ...
          <div className="glass-panel rounded-3xl p-6 border border-white/10 relative overflow-hidden">
            ...
            <div className="relative space-y-3">
              <p className="text-sm uppercase tracking-[0.25em] text-gray-300">Featured loop</p>
              <div className="rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                <img src="/images/games/01.png" alt="Featured Game" className="w-full h-56 object-cover" />
              </div>
              <div className="grid grid-cols-2 gap-2 text-sm">
                {[
                  { label: 'RTP spotlight', value: '96.4% average' },
                  { label: 'Load speed', value: '<1.2s on 4G' },
                  { label: 'Modes', value: 'Solo • Party • Tournaments' },
      ...
      <section className="section-padding grid-aurora">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <p className="text-sm uppercase tracking-[0.25em] text-gray-400 mb-2">Pick your heat</p>
            <h2 className="text-3xl md:text-4xl font-bold">Every room hits different, all are wired for speed.</h2>
          </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <p className="text-sm uppercase tracking-[0.25em] text-gray-400 mb-2">Trending right now</p>
            <h3 className="text-3xl md:text-4xl font-bold mb-3">Prime-time titles players keep returning to.</h3>
            <p className="text-gray-300 text-lg">
              Curated from live play data—these rooms are buzzing every hour.
            </p>
          </div>
      ...
      <section className="section-padding bg-[#0b1024]/70">
        <div className="container-custom grid lg:grid-cols-3 gap-6">
          {[
            { title: 'SSL-wrapped credits', copy: 'All purchases and payouts run through encrypted rails.' },
            { title: 'No ghost rooms', copy: 'We only surface titles with live, verifiable activity.' },
            { title: 'Mobile tuned', copy: 'Low-latency streams and controls optimized for thumbs.' },
          ].map((item) => (
